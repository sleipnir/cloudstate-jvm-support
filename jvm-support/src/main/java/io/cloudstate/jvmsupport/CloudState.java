...
import io.cloudstate.jvmsupport.crdt.CrdtEntity;
import io.cloudstate.jvmsupport.crdt.CrdtEntityFactory;
import io.cloudstate.jvmsupport.eventsourced.EventSourcedEntity;
import io.cloudstate.jvmsupport.eventsourced.EventSourcedEntityFactory;
import io.cloudstate.jvmsupport.impl.AnySupport;
import io.cloudstate.jvmsupport.impl.crdt.AnnotationBasedCrdtSupport;
import io.cloudstate.jvmsupport.impl.crdt.CrdtStatefulService;
import io.cloudstate.jvmsupport.impl.eventsourced.AnnotationBasedEventSourcedSupport;
import io.cloudstate.jvmsupport.impl.eventsourced.EventSourcedStatefulService;
...
public final class CloudState {
   ...
   * io.cloudstate.jvmsupport.eventsourced.EventSourcedEntity}.
   *
   ...
   *
   * <p>The entity class must be annotated with {@link io.cloudstate.jvmsupport.crdt.CrdtEntity}.
   *
   * @param entityClass The entity class.
   * @param descriptor The descriptor for the service that this entity implements.
   * @param additionalDescriptors Any additional descriptors that should be used to look up protobuf
